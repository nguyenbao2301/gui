...
def predict(pred_config):
    ...
    for i in range(len(intent_preds_max)):
        if intent_preds[i,intent_preds_max[i]] <= 7.2:
            intent_preds_max[i] = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", default="inp.txt", type=str, help="Input file for prediction")
